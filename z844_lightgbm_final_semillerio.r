...
kdataset       <- "./exp/FE8150/dataset_7130_FE.csv.gz"
ksemilla_azar  <- 998527  #Aqui poner la propia semilla
...
kexperimento   <- "KA8440_BO_004"

ksemilla_primos  <-  998527
ksemillerio  <- 100
kmax_bin           <-   31
klearning_rate     <-   0.074829004
knum_iterations    <-   91
knum_leaves        <-   34
kmin_data_in_leaf  <-   8388
kfeature_fraction  <-   0.751957627
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
