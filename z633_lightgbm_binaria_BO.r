...
hs <- makeParamSet( 
  ...
  makeNumericParam("lambda_l1", lower=  0    , upper=    50.0),
  
  makeNumericParam("lambda_l2", lower=  0    , upper=    50.0),
  
  makeIntegerParam("min_data_in_leaf", lower=  100      , upper= 15000),
...
kdataset       <- "./exp/FE8150/dataset_8150_NewVars_lag2.csv.gz"         # El dataset generado con Feature Engineering
